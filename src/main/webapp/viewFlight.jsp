...
<div class="containerV">
	...
	<div class="view-box">
		<div class="view-IdvBox">
				<label for="f_from">FROM:</label><br>
				<div class="view">
	...
	<div class="view-box">
		...
		<div class="view-IdvBox">
			<label for="f_to">FROM:</label><br>
			<div class="view">
				(<c:out value="${flight.to_f}"/>) <c:out value="${airportT.airportname}"/>
			</div><br>
			<label for="f_from">TO:</label><br>
			<div class="view">
				(<c:out value="${flight.from_f}"/>) <c:out value="${airportf.airportname}"/>
			</div>
		</div>
	...
	<div class="viewL-box">
		<div class="viewL-IdvBox">
			...
			<c:out value="${flight.flightid}"/><br>
		</div>
		
		<div class="viewL-IdvBox">
			<label for="flighttype">FLIGHT TYPE:</label>
			<c:out value="${flight.flighttype}"/><br>
		</div>
	...
	<br>
	<a href="SignUp.jsp" class="sub1">REGISTER</a><br>
</div>
<!-- Footer start here -->
	<br><br><br>

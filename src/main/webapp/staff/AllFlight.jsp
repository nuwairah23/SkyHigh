...
<!-- Welcome Staff Page -->
	...
	<c:forEach items="${fli}" var="f">
    <div class="row-flight">
    Flight ID: <c:out value="${f.flightid}"/><br> Flight Type: <c:out value="${f.flighttype}"/><br><br>
    
    <c:choose>
    <c:when test="${f.flighttype=='One-way'}">
    <div class="left-rightProfile">
    <table>
    <tr><td class="normal">FROM:      </td><td class="normal"><c:out value="${f.from_f}"/></td></tr>
    <tr><td class="normal">TO:        </td><td class="normal"><c:out value="${f.to_f}" /> </td></tr>
    <tr><td class="normal">DEPARTURE: </td><td class="normal"><c:out value="${f.departuredate}" /> </td><td class="normal"><c:out value="${f.departuretime}" /></td></tr>
    <tr><td class="normal">ARRIVAL:   </td><td class="normal"><c:out value="${f.arrivaldate}" />   </td><td class="normal"><c:out value="${f.arrivaltime}" /></td></tr>
    </table>
    </div>
    </c:when>
    <c:otherwise>
	...
	<div class="left-rightProfile">	
    <table>
    <tr><td class="normal">FROM:      </td><td class="normal"><c:out value="${f.to_f}"/></td></tr>
    <tr><td class="normal">TO:        </td><td class="normal"><c:out value="${f.from_f}" /> </td></tr>
    <tr><td class="normal">DEPARTURE: </td><td class="normal"><c:out value="${f.returndate}" /> </td><td class="normal"><c:out value="${f.returntime}" /></td></tr>
    <tr><td class="normal">ARRIVAL:   </td><td class="normal"><c:out value="${f.arrivalreturndate}" />   </td><td class="normal"><c:out value="${f.arrivalreturntime}" /></td></tr>
    </table>
    </div>
    </c:otherwise>
    </c:choose>
    ...
    <br><br>
    <div class="left-rightProfile">	PRICE: RM<c:out value="${f.price}" />  </div>
    <div class="left-rightProfile"><div class="right">
    <a class="buttonLi" href="FlightController?action=viewFlightstaff&flightid=${f.flightid}">View</a>
    <a class="buttonLi" href="FlightController?action=delflight&flightid=${f.flightid}">Delete</a></div></div>

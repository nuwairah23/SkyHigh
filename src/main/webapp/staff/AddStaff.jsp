...
Email<br>
	<input class="in" type="text" name="email" id="email" placeholder="Email" required>
	<br><br>
<div class="pw">
Password<br>
	<input class="in" type="password" name="password" id="password" placeholder="Password" required>
</div><br><br>

<a class="sub" id="open">I want to apply the Job!</a>
...
<div class="name-box">
Name<br>
	<input class="in" type="text" name="staffname" id="staffname" placeholder="Given Name as in IC/Passport" required>
	<br>
</div><br><br>

<input class="in" type="hidden" name="role" value="staff" required>

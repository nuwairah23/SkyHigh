...
<!-- Welcome Staff Page -->
<div class="table-pad">
	<c:forEach items="${pass}" var="p">
	<div class="container"><br>
    <table>
    	<tr></tr>
		<tr><td class="normal"><label for="firstname">First Name</label>:</td>  	<td class="normal"><c:out value="${p.firstname}"/></td></tr>
    	<tr><td class="normal"><label for="lastname">Last/Surname</label>:</td>  	<td class="normal"><c:out value="${p.lastname}"/></td></tr>
      	<tr><td class="normal"><label for="quantity">Contact Number</label>:</td>   	<td class="normal"><c:out value="${p.contactnumber}" /></td></tr>
    </table>
    <div class="right"><a href="PassengerController?action=viewPassenger&id=${p.passengerid}" class="sub">View</a></div><br>
    </div><br>
    </c:forEach> 
</div>
<!-- Footer start here -->

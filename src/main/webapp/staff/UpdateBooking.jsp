...
<div class="containerV">
	...
	<label>STATUS: </label>
	<input class="in" type="text" name="statusBook" id="statusBook" value="${book.status}">
	<br><br>
	<input class="in" type="hidden" name="action" id="action" value="update">
	<input class="in" type="hidden" name="id" id="id" value="${book.bookingid}">

...
<!-- START LIST -->
		<!-- Most visited -->
		<div class="table-pad">
		<h2><b>Top 5 most visited places</b></h2><br>
		...
		<thead>
  		...
  		<c:forEach items="${most}" var = "m">
			<tr>
				...
				<td><c:out value="${m.bookings}"/></td>
				<td><c:out value="${m.totalsales}"/></td>
			</tr> 
		</c:forEach>		
		</tbody>
	</table>
	...
	<br>
	<div class="right"><a href="ReportController?action=listReport1" class="sub">Full Report</a></div><br>
	</div>
	
	<!-- Number of passengers -->
	<div class="table-pad">
	<h2>Number of passengers for each flight</h2><br>
	<table class="table table-bordered table-stripped table-hover">
		<thead>
			<tr>
			    <th>Flight Id</th>
  		...
  		<tbody>
			...
			<tr>
				<td><c:out value="${n.flightid}"/></td>
				<td><c:out value="${n.passengers}"/></td>
			</tr> 
		</c:forEach>	
		</tbody>
	</table>
	<br>
	<div class="right"><a href="ReportController?action=listReport2" class="sub">Full Report</a></div><br>
	</div>
	
	
	<!-- Number of bookings made -->
		<div class="table-pad">
		<h2>Bookings made in each month with total sales</h2><br>
		...
		<thead>
  		...
  		<tbody>
			...
			<tr>
				<td><c:out value="${b.month}"/></td>
				<td><c:out value="${b.bookings}"/></td>
				<td><c:out value="${b.totalsales}"/></td>
			</tr> 
		</c:forEach>	
		</tbody>
	</table>
	<br>
	<div class="right"><a href="ReportController?action=listReport3" class="sub">Full Report</a></div><br>
	</div>

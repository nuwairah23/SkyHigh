...
<title>Staff | SkyHigh Airline</title>
...
<form>
	<table>
	<tr><td class="normal"><label for="staffid">Staff ID</label>:</td> <td class="normal"><c:out value="${staff.staffid}"/></td></tr>
	<tr><td class="normal"><label for="staffname">Staff Name</label>:</td> <td class="normal"><c:out value="${staff.staffname}"/></td></tr>
	</table><br><br>
	<a href="StaffController?action=staffList" class="sub">Back</a>
	<a href="StaffController?action=updateStaff&id=${staff.userid}" class="sub">EDIT</a>
	<a href="StaffController?action=deleteAcc&id=${staff.userid}" class="sub">DEACTIVATE ACC</a> 
</form>
<!-- Footer start here -->
	<br><br><br>

...
<form action="StaffController" method="post">
	<input type="hidden" name=id value="<%= (int)session.getAttribute("sessionId") %>">
	<label for="staffname">Staff Name: </label>: <input class="in" type="text" name="staffname" value="${staff.staffname}"><br>
	<input type="hidden" name="staffuid" id="staffuid" value="${staff.userid}">

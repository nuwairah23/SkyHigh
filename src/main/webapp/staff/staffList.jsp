...
<!-- Welcome -->	
<div class="table-pad">
<a href=" StaffController?action=addStaff" class="sub1">REGISTER</a><br><br><br>
	<c:forEach items="${staff}" var="s">
	<div class="container"><br>
	<table>
		<tr></tr>
		<tr><td class="normal"><label for="staffname">Staff Name</label>:</td> <td class="normal"><c:out value="${s.staffname}"/></td></tr>
	</table>
	<div class="right"><a href="StaffController?action=viewStaff&id=${s.staffid}" class="sub">View</a></div><br>
	</div><br>
	</c:forEach>
</div>  
<!-- Footer start here -->

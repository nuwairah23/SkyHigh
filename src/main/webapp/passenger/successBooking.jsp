...
<title>Success! | SkyHigh Airline</title>
...
<input type="hidden" name="action" value="homeP">

<div class="title-highlight">
	
			<h1><mark> THANK YOU ! </mark><br></h1>
			<br><h2>Thank you for choosing to fly with us, SkyHigh.</h2><br><br>
			<p>Your transaction was successful.</p>
			<p>Please check your email for complete document.</p>
</div>
<br><br><div class="ButCon"><input class="sub" type="submit" value="RETURN"></div>
</form>
<!-- Footer start here -->
	<br><br><br>

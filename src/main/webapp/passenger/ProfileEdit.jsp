...
<title>Profile | SkyHigh Airline</title>
...
<!-- For header and sticky header -->
	<header>
		...
		<ul>
			<li class="selHo"><a href="#home">EXPLORE</a></li>
			...
			<li class="selHo"><a href="#med">SUPPORT</a></li>
		</ul>
...
<form action="PassengerController" method="post">
		...
		<label for="firstname">First Name</label>:  	<input class="in" type="text" name="name" value="${pass.firstname}"><br>
    	<label for="lastname">Last/Surname</label>:  	<input class="in" type="text" name="lname" value="${pass.lastname}"><br>
    	<label for="sid">Passport/IC</label>:  			<input class="in" type="text" name="passic" value="${pass.passport_ic}"><br>   	
    	<label for="price">Address</label>: <br> 		<input class="in" type="text" name="address" value="${pass.address}"><br>	
      	<label for="quantity">Contact Number</label>:  	<input class="in" type="text" name="contnumber" value="${pass.contactnumber}"><br>
